...
const ROLE_RULES: Array<[RegExp, string]> = [
  ...
  [/controller\.(cs|java|kt|php|rb|go)$/i, 'controller'],
  [/repository\.(cs|java|kt|php|rb|ts)$/i, 'repository'],
  [/dbcontext\.cs$/i, 'repository'],
  [/\.service\.ts$/i, 'service'],
  [/service\.(cs|java|kt|php|rb)$/i, 'service'],
  [/\.dto\.ts$/i, 'DTO'],
  [/(dto|viewmodel)\.(cs|java|kt|php)$/i, 'DTO'],
  [/\.model\.ts$/i, 'model'],
  [/(model|entity)\.(cs|java|kt|php|rb)$/i, 'model'],
  [/^models\.py$/i, 'model'],
  [/^views\.py$/i, 'view'],
  [/^serializers\.py$/i, 'serializer'],
  [/\.enum\.ts$/i, 'enum'],
